  ...
  users: [
    {
      ...
      registeredWithReferralCode: null,
      role: "admin",
      status: "active",
      kycStatus: "verified",
      directReferrals: 0,
    ...
    },
    {
      ...
      referralCode: "MONA2001",
      registeredWithReferralCode: "ADMIN001",
      role: "user",
      status: "active",
      kycStatus: "pending",
      directReferrals: 3,
    ...
    },
    {
      ...
      referralCode: "ALI2002X",
      registeredWithReferralCode: "MONA2001",
      role: "user",
      status: "active",
      kycStatus: "verified",
      directReferrals: 12,
    ...
    },
    {
      ...
      referralCode: "SARA2003",
      registeredWithReferralCode: "ALI2002X",
      role: "user",
      status: "suspended",
      kycStatus: "rejected",
      directReferrals: 1,
